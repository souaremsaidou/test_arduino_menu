...
menu with Adafruit_HX8357 driver Adafruit_HX8357
output: not sure yet... ;)
input: Serial (not used yet...)

alternative encoder (clickEncoder) uses:
https://github.com/0xPIT/encoder // incompatible with this board because of avr/io.h missing file
...
// #include <SPI.h>
// #include <TFT_HX8357.h> // included by menu driver <menuIO/TFT_HX8357Out.h> // thanks to this code helping me to write my own
#include <menu.h>
#include <menuIO/TFT_HX8357Out.h>
#define USE_CLICK_ENCODER
//#undef USE_CLICK_ENCODER
#ifdef USE_CLICK_ENCODER
  //#include <TimerOne.h> // à prendre en compte
